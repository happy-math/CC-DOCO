import sys
sys.path.append('..')
from experiment.param_on_w_BD import par_list_w
...
for p in par_list_w:
    ...
    plt.savefig('../figures_appendix/C_BD_w_Time.pdf')
    ...
    plt.grid(True)
    plt.subplots_adjust(left=0.15)
    plt.savefig('../figures_appendix/C_BD_w_Bits.pdf')
